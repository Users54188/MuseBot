...
func TestInitConf_AllEnvVars(t *testing.T) {
	...
	os.Setenv("XUNFEI_SPARK_APP_ID", "1be7c069")
	os.Setenv("XUNFEI_SPARK_API_SECRET", "NWVhM2I4MjEyODAzZmE2NDc3YjlkMTAx")
	os.Setenv("XUNFEI_SPARK_API_KEY", "47b56bc111a294c4908ba993cda86dff")
	os.Setenv("XUNFEI_SPARK_HTTP_AUTH", "hECUEzZujvRaHWAhlJqA:WswiqFkaNMFooUVtsZUm")
	os.Setenv("XUNFEI_SPARK_HTTP_URL", "https://spark-api-open.xf-yun.com/v1/chat/completions")
	os.Setenv("XUNFEI_SPARK_WS_URL", "wss://spark-api.xf-yun.com/v3.1/chat")
	...
	assertEqual(t, BaseConfInfo.XunfeiSparkAppID, "1be7c069", "XunfeiSparkAppID")
	assertEqual(t, BaseConfInfo.XunfeiSparkAPISecret, "NWVhM2I4MjEyODAzZmE2NDc3YjlkMTAx", "XunfeiSparkAPISecret")
	assertEqual(t, BaseConfInfo.XunfeiSparkAPIKey, "47b56bc111a294c4908ba993cda86dff", "XunfeiSparkAPIKey")
	assertEqual(t, BaseConfInfo.XunfeiSparkHTTPAuth, "hECUEzZujvRaHWAhlJqA:WswiqFkaNMFooUVtsZUm", "XunfeiSparkHTTPAuth")
	assertEqual(t, BaseConfInfo.XunfeiSparkHTTPURL, "https://spark-api-open.xf-yun.com/v1/chat/completions", "XunfeiSparkHTTPURL")
	assertEqual(t, BaseConfInfo.XunfeiSparkWSURL, "wss://spark-api.xf-yun.com/v3.1/chat", "XunfeiSparkWSURL")
