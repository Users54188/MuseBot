...
type BaseConf struct {
	...
	XunfeiSparkAppID     string `json:"xunfei_spark_app_id"`
	XunfeiSparkAPISecret string `json:"xunfei_spark_api_secret"`
	XunfeiSparkAPIKey    string `json:"xunfei_spark_api_key"`
	XunfeiSparkHTTPAuth  string `json:"xunfei_spark_http_auth"`
	XunfeiSparkHTTPURL   string `json:"xunfei_spark_http_url"`
	XunfeiSparkWSURL     string `json:"xunfei_spark_ws_url"`
...
func InitConf() {
	...
	flag.StringVar(&BaseConfInfo.XunfeiSparkAppID, "xunfei_spark_app_id", "", "xunfei spark app id")
	flag.StringVar(&BaseConfInfo.XunfeiSparkAPISecret, "xunfei_spark_api_secret", "", "xunfei spark api secret")
	flag.StringVar(&BaseConfInfo.XunfeiSparkAPIKey, "xunfei_spark_api_key", "", "xunfei spark api key")
	flag.StringVar(&BaseConfInfo.XunfeiSparkHTTPAuth, "xunfei_spark_http_auth", "", "xunfei spark http auth")
	flag.StringVar(&BaseConfInfo.XunfeiSparkHTTPURL, "xunfei_spark_http_url", "https://spark-api-open.xf-yun.com/v1/chat/completions", "xunfei spark http url")
	flag.StringVar(&BaseConfInfo.XunfeiSparkWSURL, "xunfei_spark_ws_url", "wss://spark-api.xf-yun.com/v3.1/chat", "xunfei spark websocket url")
	...
	if os.Getenv("XUNFEI_SPARK_APP_ID") != "" {
		BaseConfInfo.XunfeiSparkAppID = os.Getenv("XUNFEI_SPARK_APP_ID")
	}

	if os.Getenv("XUNFEI_SPARK_API_SECRET") != "" {
		BaseConfInfo.XunfeiSparkAPISecret = os.Getenv("XUNFEI_SPARK_API_SECRET")
	}

	if os.Getenv("XUNFEI_SPARK_API_KEY") != "" {
		BaseConfInfo.XunfeiSparkAPIKey = os.Getenv("XUNFEI_SPARK_API_KEY")
	}

	if os.Getenv("XUNFEI_SPARK_HTTP_AUTH") != "" {
		BaseConfInfo.XunfeiSparkHTTPAuth = os.Getenv("XUNFEI_SPARK_HTTP_AUTH")
	}

	if os.Getenv("XUNFEI_SPARK_HTTP_URL") != "" {
		BaseConfInfo.XunfeiSparkHTTPURL = os.Getenv("XUNFEI_SPARK_HTTP_URL")
	}

	if os.Getenv("XUNFEI_SPARK_WS_URL") != "" {
		BaseConfInfo.XunfeiSparkWSURL = os.Getenv("XUNFEI_SPARK_WS_URL")
	}
...
func logConf(allowedUserIds, allowedGroupIds string) {
	...
	logger.Info("CONF", "XunfeiSparkAppID", BaseConfInfo.XunfeiSparkAppID)
	logger.Info("CONF", "XunfeiSparkAPISecret", BaseConfInfo.XunfeiSparkAPISecret)
	logger.Info("CONF", "XunfeiSparkAPIKey", BaseConfInfo.XunfeiSparkAPIKey)
	logger.Info("CONF", "XunfeiSparkHTTPAuth", BaseConfInfo.XunfeiSparkHTTPAuth)
	logger.Info("CONF", "XunfeiSparkHTTPURL", BaseConfInfo.XunfeiSparkHTTPURL)
	logger.Info("CONF", "XunfeiSparkWSURL", BaseConfInfo.XunfeiSparkWSURL)
